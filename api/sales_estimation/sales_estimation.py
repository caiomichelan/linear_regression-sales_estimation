...
class Sales_Estimation(object):
    def __init__(self):
        ...
        self.scaler_competition_distance = pickle.load (open(self.home_path +'parameters/scaler_competition_distance.pkl', 'rb'))
        self.scaler_competition_time_month = pickle.load (open(self.home_path +'parameters/scaler_competition_time_month.pkl', 'rb'))
        self.scaler_promo_time_week = pickle.load (open(self.home_path +'parameters/scaler_promo_time_week.pkl', 'rb'))
        self.scaler_year = pickle.load (open(self.home_path +'parameters/scaler_year.pkl', 'rb'))
        self.enc_store_type = pickle.load(open(self.home_path +'parameters/enc_store_type.pkl', 'rb'))
